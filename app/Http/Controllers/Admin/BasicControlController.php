...
class BasicControlController extends Controller
{
    ...
    public function basicControlUpdate(Request $request)
    {
        $request->validate([
            ...
            'whatsapp_mesage' => 'required|string|min:3|max:255',
        ...
        try {
            ...
            $response = BasicControl::updateOrCreate([
                ...
                'whatsapp_mesage' => $request->whatsapp_mesage,
    ...
    public function bookingChargeUpdate(Request $request)
    {
        $this->validate($request, [
            'charge' => 'required',
            'user_gst_charge_above_amount' => 'required',
            'user_gst_charge_under_amount' => 'required',
        ...
        BasicControl::updateOrCreate([
            ...
            'user_service_charge' => $request->user_service_charge,
            'user_gst_charge_under_amount' => $request->user_gst_charge_under_amount,
            'user_gst_charge_above_amount' => $request->user_gst_charge_above_amount,
        ]);
