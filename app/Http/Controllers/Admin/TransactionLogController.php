...
class TransactionLogController extends Controller
{
    public function transaction()
    {
        ...
        $data['percentages'] = [
            'today' => $total ? round(($data['transactionStats']->today / $total) * 100, 2): 0,
            'this_week' => $total? round(($data['transactionStats']->this_week / $total) * 100, 2): 0,
            'this_month' => $total? round(($data['transactionStats']->this_month / $total) * 100, 2): 0,
            'this_year' => $total? round(($data['transactionStats']->this_year / $total) * 100, 2): 0,
        ];
