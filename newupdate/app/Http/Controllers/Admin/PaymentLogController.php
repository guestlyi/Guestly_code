...
class PaymentLogController extends Controller
{
    ...
    public function pending()
    {
        ...
        $data['percentages'] = [
            'today' => $total ? round(($data['depositStats']->today / $total) * 100, 2) : 0,
            'this_week' => $total ? round(($data['depositStats']->this_week / $total) * 100, 2) : 0,
            'this_month' => $total ? round(($data['depositStats']->this_month / $total) * 100, 2) : 0,
            'this_year' => $total ? round(($data['depositStats']->this_year / $total) * 100, 2) : 0,
        ];
