                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.basic.control.update') }}" method="post">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label for="whatsappNumberLabel" class="form-label">@lang("Whatsapp Number")</label>
                                        <input type="text"
                                               class="form-control @error('whatsapp_number') is-invalid @enderror"
                                               name="whatsapp_number" id="whatsappNumberLabel"
                                               placeholder="@lang("Whatsapp Number")"
                                               aria-label="@lang("Whatsapp NUmber")"
                                               autocomplete="off"
                                               value="{{ old('whatsapp_number', $basicControl->whatsapp_number) }}">
                                        @error('whatsapp_number')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="whatsappMesageLabel" class="form-label">@lang("Whatsapp Message")</label>
                                        <input type="text"
                                               class="form-control @error('whatsapp_mesage') is-invalid @enderror"
                                               name="whatsapp_mesage" id="whatsappMesageLabel"
                                               placeholder="@lang("Whatsapp Mesage")"
                                               aria-label="@lang("Whatsapp Mesage")"
                                               autocomplete="off"
                                               value="{{ old('whatsapp_mesage', $basicControl->whatsapp_mesage) }}">
                                        @error('whatsapp_mesage')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>    
                                </div>
